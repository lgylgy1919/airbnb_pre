...
def go_conversation(request, a_pk, b_pk):
    ...
    if user_one is not None and user_two is not None:
        try: 
            ...
            conversation = models.Conversation.objecets.create()
            conversation.participatns.add(user_one user_two)
        return direct(reverse("conversations:detail", kwargs={'pk':conversation.pk}))
